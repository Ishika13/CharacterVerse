...
import com.google.mediapipe.examples.llminference.viewmodel.ChatViewModel

/**
 * ChatRoute is a composable that represents the chat screen for a given character.
 * It uses the ChatViewModel to manage the chat messages and send messages to the character.
 * @param navController: NavController to navigate between screens.
 * @param characterName: Name of the character to chat with.
 * @param chatViewModel: ChatViewModel to manage the chat messages.
 * @return A composable that represents the chat screen for a given character.
 */
@Composable
internal fun ChatRoute(
    ...
    val characterContext = chatViewModel.getCharacterContext(characterName)
    ChatScreen(
        navController = navController,
